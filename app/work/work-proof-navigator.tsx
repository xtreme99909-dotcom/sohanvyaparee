...
const proofPaths = [
  {
    ...
    headline: 'Start with a real transaction path.',
    summary: 'The strongest evidence for a commerce launch is a working journey that carries a customer from appetite and choice through verification, delivery logic and payment.',
    risk: 'A beautiful storefront that breaks when buying becomes practical.',
    signals: ['Mobile-first decision flow', 'Verification and delivery logic', 'Cart, payment and launch ownership'],
    href: '/work/bongfoods',
    tone: 'food',
  },
  {
